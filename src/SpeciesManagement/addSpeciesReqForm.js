...
function AddSpeciesReqForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch("http://localhost:8081/speciesRequest/addSpeciesRequest", {
                method: "POST",
                body: formData,
            });
            ...
            if (response.ok) {
                alert("Species Request added successfully!");
                // Reset form
                setForm({
                    requesterName: "",
                    scientificName: "",
            ...
            alert("Something went wrong while adding species request." + error);
        }
    };
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="flex flex-col">
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#17A9D3] ${errors.scientificName ? "border-red-500" : "border-gray-300"
                                            }`}
                                    />
                                ...
                                <div className="flex flex-col">
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#17A9D3] ${errors.commonName ? "border-red-500" : "border-gray-300"
                                            }`}
                                    />
                                    {errors.commonName && (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="flex flex-col">
                                ...
                                <select
                                    ...
                                    value={form.category}
                                    onChange={handleChange}
                                    className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#17A9D3] ${errors.category ? "border-red-500" : "border-gray-300"
                                        }`}
                                >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="flex flex-col">
                                ...
                                <select
                                    ...
                                    value={form.habitat}
                                    onChange={handleChange}
                                    className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#17A9D3] ${errors.habitat ? "border-red-500" : "border-gray-300"
                                        }`}
                                >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="flex flex-col">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#17A9D3] ${errors.updatedDate ? "border-red-500" : "border-gray-300"
                                        }`}
                                />
                                {errors.updatedDate && (
                            ...
                            <div className="flex flex-col">
                                ...
                                <input
                                    ...
                                    accept="image/*"
                                    onChange={handleChange}
                                    className={`w-full text-gray-700 border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#17A9D3] ${errors.image ? "border-red-500" : "border-gray-300"
                                        }`}
                                />
                                {errors.image && (
...
export default AddSpeciesReqForm;
